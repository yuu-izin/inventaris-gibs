        ...
        <div class="flex justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    Halaman Tambah Officer
                </h2>
                <div class="text-sm text-gray-500">Halaman untuk menambahkan Data Officer</div>
            </div>
            <div>
                <a href="{{ route('officer.index') }}" class="bg-blue-950 text-white rounded-md py-2 px-4 text-sm">Kembali</a>
            </div>
        </div>
    </x-slot>
